...
namespace CSharpEgitimKampi501
{
    public partial class Form1 : Form
    {
        ...
        private async void btnList_Click(object sender, EventArgs e)
        {
            ...
            var values = await connection.QueryAsync<ResultProductDto>(query1);
            dataGridView1.DataSource = values;
        }
        ...
        private async void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            parameters.Add("@productId", txtProductId.Text);
            await connection.ExecuteAsync(query, parameters);
            MessageBox.Show("Kitap Güncelleme İşlemi Başarılı Bir Şekilde Yapıldı",
                "Güncelleme", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
